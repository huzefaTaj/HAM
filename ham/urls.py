...
urlpatterns = [
    ...
    path('reset-password/<str:uidb64>/<str:token>/', accounts_views.reset_password_view, name='reset_password'),
    ...
    path('expenses/<str:txn_type>/<str:txn_id>/edit/', expenses_views.edit_transaction, name='edit_transaction'),
    path('expenses/<str:txn_type>/<str:txn_id>/delete/', expenses_views.delete_transaction, name='delete_transaction'),
